...
```
$ https://github.com/kareemalshfy00/kareemalshafey.git
```

- Change to cloned directory and run `kareem.sh` -
```
$ cd kareemaslhefay
$ bash kareem.sh
```

- On first launch, It'll install the dependencies and that's it. `kareem` is installed.

### Run on Docker
```
$ docker pull htrtech/kareem
$ docker run --rm -it htrtech/kareem
```

### Dependencies

**`kareemalshafy`** requires following programs to run properly - 
- `php`
- `wget`
- `curl`
- `git`

> All the dependencies will be installed automatically when you run `kareem` for the first time.
